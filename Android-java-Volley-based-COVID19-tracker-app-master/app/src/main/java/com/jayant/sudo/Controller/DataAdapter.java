...
public class DataAdapter extends RecyclerView.Adapter<DataAdapter.DataViewHolder> {
    ...
    public void onBindViewHolder(@NonNull DataViewHolder holder, int position) {
        ...
        holder.city.setText("State: "+data.getLocation());
        holder.confirm_indians.setText("Confirmed Indians: "+data.getConfirm_cases_indian());
        holder.confirm_foreign.setText("Confirmed Foreign: "+data.getConfirm_cases_foreign());
        holder.deaths.setText("Deaths: "+data.getDeaths());
        holder.discharge.setText("Discharges: "+data.getDischarge());
        holder.total_confirms.setText("Confirmed Cases: "+data.getTotal_confirm());
