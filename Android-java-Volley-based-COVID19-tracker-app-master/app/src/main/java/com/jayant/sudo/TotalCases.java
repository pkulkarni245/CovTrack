        ...
        StringRequest request=new StringRequest(Request.Method.GET, URL_DATA, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    confirm_cases_india.setText("Confirmed Indian Cases: "+jsonObject2.getInt("confirmedCasesIndian"));
                    confirm_cases_foreign.setText("Confirmed Foreigner Cases: "+jsonObject2.getInt("confirmedCasesForeign"));
                    discharge.setText("Discharged: "+jsonObject2.getInt("discharged"));
                    deaths.setText("Deaths: "+jsonObject2.getInt("deaths"));
                    confim_but_no_location.setText("Confirmed but Location Undefined: "+jsonObject2.getInt("confirmedButLocationUnidentified"));
